...
import cv2  # OpenCV to read video: pip install opencv-python
import base64
import time
import requests
import tempfile
...
prompt = "My grandma and I used to watch ESPN announcer Stephen Smith. She is ill. Cheer me up by creafting a short script summarizing these basketball video clip frames in the style of Stephen Smith so I'll be happy."
...
if st.button('Stephen Smith-ify!', type="primary") and uploaded_file is not None:
    ...
    with st.spinner('Processing...'):
        ...
        prompt += f"(This video clip is {video_length} seconds long. Make sure the output text takes includes no more than {rough_num_words})"
        ...
        message = Mail(
            from_email='stephen_smith@sf.com',
            to_emails=email,
            subject='New Video',
